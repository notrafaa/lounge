...
export function Sidebar() {
  return (
    <aside className="hidden w-64 shrink-0 border-r border-white/10 bg-black/25 p-4 md:block">
      <div className="mb-8 flex items-center gap-3">
        <img src="/images/lounge-wordmark.png" alt="lounge" className="h-8 w-auto object-contain" />
      </div>
